...
class Shipment extends Authenticated_Controller
{
			...
			if ($this->db->trans_status() === FALSE) {
				...
				if ($payment_type === 'TRANSFER') {
					...
					$pesan_user = "*KRIBO EXPRESS*\n\n" .
						...
						"_Terima kasih telah memilih Kribo Express_";
	...
	public function print_label($no_resi)
	{
		...
		// $logoPath = FCPATH . 'assets/logo/icon-kribo-express.png';
		$logoPath = FCPATH . 'assets/logo/logo-03.png';
	...
	public function export_manifest()
	{
		...
		$styleHeader = [
			...
			'fill' => [
				...
				'startColor' => ['rgb' => '0052CC'] // Warna biru 
			],
		];
		...
		$row += 3;
		$sheet->setCellValue('B' . $row, 'Diserahkan Oleh (Kribo),');
