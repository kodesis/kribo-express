			...
			<div class="col-lg-4">
				...
				<div class="card bg-primary-lt">
					<div class="card-body">
						...
						<div class="d-flex justify-content-between align-items-center mb-2">
							<span class="text-dark small">PPn</span>
							<span class="fw-bold text-dark small" id="lbl_tax_cost">Rp 0</span>
						</div>
...
<script>
	document.addEventListener("DOMContentLoaded", function() {
		...
		const lblTaxCost = document.getElementById('lbl_tax_cost');
		...
		function calculateAll() {
			...
			document.querySelectorAll('.dim-row').forEach(row => {
				...
				// document.querySelectorAll('.dim-qty').forEach(el => console.log(el.value))
			...
			document.querySelectorAll('.dim-row').length
			console.log('jumlah dim-row:', document.querySelectorAll('.dim-row').length);
			...
			let ppn = grandTotal * 0.011;

			lblTaxCost.innerText = formatRp(ppn);
