				...
				<div class="card-body">
					...
					<div class="row">
						<div class="col-md-4 col-12">
							<div class="mb-3">
								<label class="form-label required">Harga Modal</label>
								<div class="input-group input-group-flat">
									<span class="input-group-text">Rp</span>
									<input type="text" id="harga_modal_display" class="form-control <?= form_error('harga_modal_display') ? 'is-invalid' : '' ?>" value="<?= set_value('harga_modal_display', '0') ?>" placeholder="0">
									<input type="hidden" name="harga_modal" id="harga_modal">
								</div>
								<?php if (form_error('harga_modal_display')): ?>
									<div class="text-danger small mt-1"><?= form_error('harga_modal_display') ?></div>
								<?php endif; ?>
							</div>
						</div>
						<div class="col-md-4 col-12">
							<div class="mb-3">
								...
								<div class="input-group input-group-flat">
									<span class="input-group-text">Rp</span>
									<input type="text" id="harga_jual_display" class="form-control <?= form_error('harga_jual_display') ? 'is-invalid' : '' ?>" value="<?= set_value('harga_jual_display') ?>" placeholder="0">
									<input type="hidden" name="harga_jual" id="harga_jual">
								</div>
								<?php if (form_error('harga_jual_display')): ?>
									<div class="text-danger small mt-1"><?= form_error('harga_jual_display') ?></div>
								<?php endif; ?>
							</div>
						</div>
						<div class="col-md-4 col-12">
...
<script>
	document.addEventListener("DOMContentLoaded", function() {
		...
		initCurrencyInput('harga_modal_display', 'harga_modal');
		initCurrencyInput('harga_jual_display', 'harga_jual');
	});
</script>
