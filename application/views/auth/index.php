...
<head>
	...
	<title><?= $title ?> - Kribo Express</title>
	...
	<div class="page page-center">
		<div class="container container-tight py-4">
			<div class="text-center mb-4">
				<a href="<?= base_url() ?>" class="navbar-brand navbar-brand-autodark"><img src="<?= base_url() ?>assets/logo/logo-03.png" width="250" alt="Kribo Express"></a>
			</div>
